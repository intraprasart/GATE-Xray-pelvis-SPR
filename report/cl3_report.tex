...
ผลสรุป: พบ\textbf{หลักฐานสองอย่างที่สอดคล้องกับฟิสิกส์} --- (1)~\textbf{สัญญาณแรงสุดที่พลังงานต่ำ}
(E=40~keV เด่นกว่าพลังงานสูงอย่างมีนัยสำคัญ, $p=0.0001$) ตามที่ photoelectric ทำนาย; และ
(2)~\textbf{baseline SPR ลดลงอย่าง monotonic} ตามพลังงาน ($\rho=-1.00$, $p<0.001$) ---
อย่างไรก็ตาม\textbf{โครงสร้างละเอียดในช่วง 60--120~keV ยังมี noise สูงที่ $N=10$} (E=60 ไม่ถึงนัยสำคัญ
เพราะ 3 seeds เป็นบวก) ดังนั้นเส้นโค้งพลังงานเชิงปริมาณที่คมชัดต้องการ seed มากขึ้น
\textbf{สรุป: กลไกได้รับการสนับสนุน (โดยเฉพาะการเสริมที่พลังงานต่ำ) แต่ยังไม่สมบูรณ์เชิงปริมาณ}
...
\begin{keybox}
\textbf{กลไกเชิงพลังงาน:}\ \textcolor{ok}{$\boxtimes$ \textbf{สนับสนุน}} (โดยเฉพาะการเสริมที่พลังงานต่ำ)
\textcolor{warn}{$+$ ยังไม่สมบูรณ์เชิงปริมาณ}\\[4pt]
หลักฐานสองอย่างสอดคล้องกับฟิสิกส์ของการลดทอนในกระดูก: (1)~\textbf{สัญญาณแรงสุดที่ 40~keV}
($p=0.0001$ เทียบพลังงานสูง) ตาม photoelectric; (2)~\textbf{baseline SPR ลดลง monotonic} ($\rho=-1.00$).
สิ่งเหล่านี้บ่งชี้ว่าสัญญาณ\textbf{ผูกกับฟิสิกส์การลดทอน มิใช่ artifact เชิงตัวเลข}. อย่างไรก็ตาม
เส้นโค้งพลังงานเชิงปริมาณในช่วง 60--120~keV \textbf{ยังไม่คมชัดที่ $N=10$} --- ต้องเพิ่ม seed เพื่อยืนยัน
\end{keybox}
...
\begin{itemize}
  ...
  \item \textbf{งานถัดไป:} รันซ้ำที่ \code{n_seeds=20--30} ต่อพลังงาน เพื่อลด noise และยืนยันเส้นโค้ง
        $|\Delta\mathrm{SPR}|(E)$ เชิงปริมาณ; พิจารณาแยก primary/scatter เพื่อดูองค์ประกอบเชิงพลังงาน
\end{itemize}
