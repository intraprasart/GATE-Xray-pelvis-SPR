...
จากรอยแตกสามารถ\textbf{ตรวจพบได้อย่างมีนัยสำคัญ}แม้ที่รอยแตกขนาดเล็กที่สุด (0.306~มม.;
$t=-3.12$, $p=0.017$) และ\textbf{ความแรงของสัญญาณเพิ่มขึ้นตามขนาดรอยแตก} ซึ่งสนับสนุนว่าสัญญาณที่วัดได้
...
เทียบกับบริเวณอ้างอิง จะเห็นว่าสัญญาณที่รอยแตก\textbf{มีนัยสำคัญ}และ\textbf{ความแรง ($|t|$) เพิ่มขึ้น
ตามขนาดรอยแตก} ในขณะที่บริเวณอ้างอิงไม่มีนัยสำคัญ (null) --- ยืนยันความจำเพาะของสัญญาณ
...
0.54 มม.\  & \multicolumn{4}{c}{\textit{กำลังดำเนินการ (ในคิว)}} \\
1.0 มม.\   & \multicolumn{4}{c}{\textit{กำลังดำเนินการ (ในคิว)}} \\
\bottomrule
\end{tabular}
\end{table}
...
\includegraphics[width=0.66\textwidth]{fig/trend.png}
\caption{ความแรงของสัญญาณ ($|t|$) ที่บริเวณรอยแตก เพิ่มขึ้นตามขนาดรอยแตก
(สองจุดแรกเสร็จสมบูรณ์ อีกสองขนาดอยู่ระหว่างดำเนินการ) เส้นประแสดงระดับนัยสำคัญ}
\label{fig:trend}
\end{figure}

\begin{figure}[h]\centering
\includegraphics[width=0.92\textwidth]{fig/sigmap.png}
\caption{แผนที่ผลต่าง SPR เฉลี่ย (ซ้าย) และแผนที่นัยสำคัญ $t$ ต่อพิกเซล (ขวา) ของรอยแตก 0.43~มม.
กรอบสีเขียวคือ ROI ที่กำหนดล่วงหน้าที่ตำแหน่งรอยแตก}
\label{fig:sig}
\end{figure}
...
\begin{enumerate}
  ...
  \item \textbf{มีหลักฐานสนับสนุนสัญญาณจริง:} สัญญาณมีนัยสำคัญที่ตำแหน่งรอยแตกซึ่งกำหนดไว้ล่วงหน้า
        ในขณะที่บริเวณอ้างอิงเป็น null และ\textbf{ความแรงเพิ่มขึ้นตามขนาดรอยแตก} ซึ่งเป็นรูปแบบที่คาดหวัง
        ของสัญญาณเชิงสาเหตุ มิใช่สัญญาณรบกวนแบบสุ่ม
\end{enumerate}

\section{ข้อจำกัดและงานถัดไป}
\begin{itemize}
  \item ผลปัจจุบันเป็น\textbf{เบื้องต้น} (2 จาก 4 ขนาด, $N=8$ เมล็ด) และสัญญาณที่รอยแตกเล็กสุดยัง
        \textbf{ก้ำกึ่ง} --- ควรเพิ่มจำนวนเมล็ดและสถิติเพื่อยืนยัน และพิจารณาการแก้ไข multiple comparison
  \item ทำ sweep ให้ครบทั้ง 4 ขนาด เพื่อได้เส้นโค้ง detectability threshold ที่สมบูรณ์
